...
aofs.each do |name|
  Aof.create!(name: name)
end
puts "Created #{Aof.count} areas of focus"
...
# spec/models/patient_language_spec.rb

```rb
require 'rails_helper'

RSpec.describe PatientLanguage, type: :model do
  pending "add some examples to (or delete) #{__FILE__}"
end
...
# spec/models/employee_location_spec.rb

```rb
require 'rails_helper'

RSpec.describe EmployeeLocation, type: :model do
  pending "add some examples to (or delete) #{__FILE__}"
end

```

# spec/models/employee_language_spec.rb

```rb
require 'rails_helper'

RSpec.describe EmployeeLanguage, type: :model do
  pending "add some examples to (or delete) #{__FILE__}"
end

```

# spec/models/employee_aof_spec.rb

```rb
require 'rails_helper'

RSpec.describe EmployeeAof, type: :model do
  pending "add some examples to (or delete) #{__FILE__}"
end
...
# spec/models/aof_spec.rb

```rb
require 'rails_helper'

RSpec.describe Aof, type: :model do
  pending "add some examples to (or delete) #{__FILE__}"
end
...
# spec/factories/patient_languages.rb

```rb
FactoryBot.define do
  factory :patient_language do
...
# spec/factories/employee_locations.rb
...
# spec/factories/employee_languages.rb
...
# spec/factories/employee_aofs.rb

```rb
FactoryBot.define do
  factory :employee_aof do
